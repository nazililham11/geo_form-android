        ...
        notesCursor?.apply {
            while (moveToNext()) {
                val note = Note(
                    ...
                    ukuran_tiang          = getString(getColumnIndexOrThrow(NoteColumns.UKURAN_TIANG)),
                    jumlah_tiang          = getString(getColumnIndexOrThrow(NoteColumns.JUMLAH_TIANG)),
                    tipe_guy_pole         = getString(getColumnIndexOrThrow(NoteColumns.TIPE_GUY_POLE)),
                    jumlah_guy_pole       = getString(getColumnIndexOrThrow(NoteColumns.JUMLAH_GUY_POLE)),
                    ...
                    jumlah_cross_arm      = getString(getColumnIndexOrThrow(NoteColumns.JUMLAH_CROSS_ARM)),
                    ...
                    jarak_tiang_ke_jalan  = getString(getColumnIndexOrThrow(NoteColumns.JARAK_TIANG_KE_JALAN)),
